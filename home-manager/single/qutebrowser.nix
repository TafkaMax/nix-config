...
{
  home.file."config.py".text = ''
config.bind('<Ctrl+#>', 'hint links spawn --detach mpv {hint-url}')
config.load_autoconfig(False)
config.source('onedark.py')
    '';
  home.file."config.py".target = ".config/qutebrowser/config.py";
  
  home.file."onedark.py".text = ''
...
bg_default = "#202335"          # main shade darkest
bg_lighter = "#353b45"
bg_selection = "#3e4451"
# "#545862"
fg_disabled = "#565c64"
...
# c.colors.webpage.bg = bg_default
  ''; 
  home.file."onedark.py".target = ".config/qutebrowser/onedark.py";
}
